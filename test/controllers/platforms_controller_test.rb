...
class PlatformsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create platform" do
    assert_difference("Platform.count") do
      post platforms_url, params: { platform: { manufacturer: @platform.manufacturer, name: @platform.name, releaseDate: @platform.releaseDate } }
    end
  ...
  test "should update platform" do
    patch platform_url(@platform), params: { platform: { manufacturer: @platform.manufacturer, name: @platform.name, releaseDate: @platform.releaseDate } }
